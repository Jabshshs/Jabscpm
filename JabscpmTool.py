...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.red_to_blue, '{01}: Increase Money           1.5K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{02}: Increase Coins           4.5K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{03}: King Rank                8K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{04}: Change ID                4.5K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{05}: Change Name              100'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{06}: Change Name (Rainbow)    100'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{07}: Number Plates            2K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{08}: Account Delete           FREE'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{09}: Account Register         FREE'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{10}: Delete Friends           500'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{11}: Unlock Paid Cars         5k'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{12}: Unlock all Cars          6K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{13}: Unlock all Cars Siren    3.5K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{14}: Unlock w16 Engine        4K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{15}: Unlock All Horns         3K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{16}: Unlock Disable Damage    3K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{17}: Unlock Unlimited Fuel    3K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{18}: Unlock House 3           4K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{19}: Unlock Smoke             4K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{20}: Unlock Wheels            4K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{21}: Unlock Animations        2K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{22}: Unlock Equipaments M     3K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{23}: Unlock Equipaments F     3K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{24}: Change Race Wins         1K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{25}: Change Race Loses        1K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{26}: Clone Account            7K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{27}: Inner car 414hp          2.5k'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{28}: Custom Angle             1.5k'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{29}: Custom Tire burner       1.5K'))
            print(Colorate.Horizontal(Colors.red_to_blue, '{0} : Exit'))
            
            print(Colorate.Horizontal(Colors.red_to_blue, '===============[ 𝐂𝐏𝐌 ]==============='))

...
from Jabscpm import Jabshshs

__CHANNEL_USERNAME__ = "JabsMainChannel"
__GROUP_USERNAME__   = "JabsMainChat"
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.red_to_yello, '=============[ 𝐋𝐎𝐂𝐀𝐓𝐈𝐎𝐍 ]============='))
    print(Colorate.Horizontal(Colors.red_to_yello, f'Ip Address : {data.get("query")}.'))
    print(Colorate.Horizontal(Colors.red_to_yello, f'Location   : {data.get("city")} {data.get("regionName")} {data.get("countryCode")}.'))
    print(Colorate.Horizontal(Colors.red_to_yello, f'Country    : {data.get("country")} {data.get("zip")}.'))
    print(Colorate.Horizontal(Colors.red_to_yello, '===============[ 𝐌𝐄𝐍𝐔 ]==============='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = Jabshshs(acc_access_key)
        login_response = cpm.login(acc_email, acc_password)
        if login_response != 0:
            if login_response == 100:
                print(Colorate.Horizontal(Colors.red_to_yello, 'ACCOUNT NOT FOUND.'))
                sleep(2)
                continue
            elif login_response == 101:
                print(Colorate.Horizontal(Colors.red_to_yello, 'WRONG PASSWORD.'))
                sleep(2)
                continue
            elif login_response == 103:
                print(Colorate.Horizontal(Colors.red_to_yello, 'INVALID ACCESS KEY.'))
                sleep(2)
                continue
            else:
                print(Colorate.Horizontal(Colors.red_to_yello, 'TRY AGAIN.'))
                print(Colorate.Horizontal(Colors.red_to_yello, '! Note: make sure you filled out the fields !.'))
                sleep(2)
                continue
        else:
            print(Colorate.Horizontal(Colors.red_to_yello, 'SUCCESSFUL.'))
            sleep(2)
        while True:
            banner(console)
            ...
            print(Colorate.Horizontal(Colors.red_to_yello, '{01}: Increase Money           1.5K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{02}: Increase Coins           4.5K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{03}: King Rank                8K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{04}: Change ID                4.5K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{05}: Change Name              100'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{06}: Change Name (Rainbow)    100'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{07}: Number Plates            2K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{08}: Account Delete           FREE'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{09}: Account Register         FREE'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{10}: Delete Friends           500'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{11}: Unlock Paid Cars         5k'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{12}: Unlock all Cars          6K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{13}: Unlock all Cars Siren    3.5K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{14}: Unlock w16 Engine        4K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{15}: Unlock All Horns         3K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{16}: Unlock Disable Damage    3K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{17}: Unlock Unlimited Fuel    3K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{18}: Unlock House 3           4K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{19}: Unlock Smoke             4K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{20}: Unlock Wheels            4K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{21}: Unlock Animations        2K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{22}: Unlock Equipaments M     3K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{23}: Unlock Equipaments F     3K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{24}: Change Race Wins         1K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{25}: Change Race Loses        1K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{26}: Clone Account            7K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{27}: Inner car 414hp          2.5k'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{28}: Custom Angle             1.5k'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{29}: Custom Tire burner       1.5K'))
            print(Colorate.Horizontal(Colors.red_to_yello, '{0} : Exit'))
            
            print(Colorate.Horizontal(Colors.red_to_yello, '===============[ 𝐂𝐏𝐌 ]==============='))

...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(glow_orange, '{01}: Increase Money           1.5K'))
            print(Colorate.Horizontal(glow_orange, '{02}: Increase Coins           4.5K'))
            ...
            print(Colorate.Horizontal(glow_orange, '{10}: Delete Friends           500'))
            print(Colorate.Horizontal(glow_orange, '{11}: Unlock Paid Cars         5k'))
            print(Colorate.Horizontal(glow_orange, '{12}: Unlock all Cars          6K'))
            print(Colorate.Horizontal(glow_orange, '{13}: Unlock all Cars Siren    3.5K'))
            print(Colorate.Horizontal(glow_orange, '{14}: Unlock w16 Engine        4K'))
            print(Colorate.Horizontal(glow_orange, '{15}: Unlock All Horns         3K'))
            print(Colorate.Horizontal(glow_orange, '{16}: Unlock Disable Damage    3K'))
            print(Colorate.Horizontal(glow_orange, '{17}: Unlock Unlimited Fuel    3K'))
            print(Colorate.Horizontal(glow_orange, '{18}: Unlock House 3           4K'))
            print(Colorate.Horizontal(glow_orange, '{19}: Unlock Smoke             4K'))
            print(Colorate.Horizontal(glow_orange, '{20}: Unlock Wheels            4K'))
            print(Colorate.Horizontal(glow_orange, '{21}: Unlock Animations        2K'))
            print(Colorate.Horizontal(glow_orange, '{22}: Unlock Equipaments M     3K'))
            print(Colorate.Horizontal(glow_orange, '{23}: Unlock Equipaments F     3K'))
            print(Colorate.Horizontal(glow_orange, '{24}: Change Race Wins         1K'))
            print(Colorate.Horizontal(glow_orange, '{25}: Change Race Loses        1K'))
            print(Colorate.Horizontal(glow_orange, '{26}: Clone Account            7K'))
            print(Colorate.Horizontal(glow_orange, '{27}: Inner car 414hp          2.5k'))
            print(Colorate.Horizontal(glow_orange, '{28}: Custom Angle             1.5k'))
            print(Colorate.Horizontal(glow_orange, '{29}: Custom Tire burner       1.5K'))
            print(Colorate.Horizontal(glow_orange, '{0} : Exit'))
            
            print(Colorate.Horizontal(glow_orange, '===============[ 𝐂𝐏𝐌 ]==============='))

...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{01}: Increase Money           1.5K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{02}: Increase Coins           4.5K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{03}: King Rank                8K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{04}: Change ID                4.5K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{05}: Change Name              100'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{06}: Change Name (Rainbow)    100'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{07}: Number Plates            2K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{08}: Account Delete           FREE'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{09}: Account Register         FREE'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{10}: Delete Friends           500'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{11}: Unlock Paid Cars         5k'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{12}: Unlock all Cars          6K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{13}: Unlock all Cars Siren    3.5K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{14}: Unlock w16 Engine        4K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{15}: Unlock All Horns         3K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{16}: Unlock Disable Damage    3K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{17}: Unlock Unlimited Fuel    3K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{18}: Unlock House 3           4K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{19}: Unlock Smoke             4K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{20}: Unlock Wheels            4K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{21}: Unlock Animations        2K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{22}: Unlock Equipaments M     3K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{23}: Unlock Equipaments F     3K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{24}: Change Race Wins         1K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{25}: Change Race Loses        1K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{26}: Clone Account            7K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{27}: Inner car 414hp          2.5k'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{28}: Custom Angle             1.5k'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{29}: Custom Tire burner       1.5K'))
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '{0} : Exit'))
            
            print(Colorate.Horizontal(Colors.dark_red_to_dark_gray, '===============[ 𝐂𝐏𝐌 ]==============='))
